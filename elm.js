...
var author$project$Main$OmikujiResultPage = function (a) {
	return {$: 'OmikujiResultPage', a: a};
};
var author$project$Page$Home$Model = F2(
	function (records, key) {
		return {key: key, records: records};
	});
var author$project$Page$Home$Record = F2(
	function (checked, name) {
		return {checked: checked, name: name};
	});
		...
		var initRecordList = function () {
			if (names.$ === 'Nothing') {
				...
				return A2(
					elm$core$List$map,
					function (s) {
						return A2(author$project$Page$Home$Record, true, s);
					},
					A2(elm$core$String$split, ',', str));
			}
		}();
		return _Utils_Tuple2(
			A2(author$project$Page$Home$Model, initRecordList, key),
			elm$core$Platform$Cmd$none);
	});
var author$project$Page$OmikujiResult$Model = F2(
	function (roles, names) {
		return {names: names, roles: roles};
	});
var author$project$Page$OmikujiResult$makeInitialRoles = F2(
	function (roles, n) {
		makeInitialRoles:
		while (true) {
			if (!n) {
				...
				var $temp$roles = A2(elm$core$List$cons, 'D', roles),
					$temp$n = n - 1;
				roles = $temp$roles;
				n = $temp$n;
				continue makeInitialRoles;
			}
		}
	});
...
var author$project$Page$OmikujiResult$shuffleRole = F2(
	function (seed, srcList) {
		return A2(
			elm$random$Random$step,
			elm_community$random_extra$Random$List$shuffle(srcList),
			elm$random$Random$initialSeed(
				A2(elm$core$Maybe$withDefault, 0, seed))).a;
	});
var author$project$Page$OmikujiResult$init = F2(
	function (names, seed) {
		var initialNames = function () {
			if (names.$ === 'Nothing') {
				return _List_Nil;
			} else {
				var str = names.a;
		...
		var basicRoles = _List_fromArray(
			['S', 'P']);
		var initialRoles = A2(
			author$project$Page$OmikujiResult$shuffleRole,
			seed,
			A2(
				author$project$Page$OmikujiResult$makeInitialRoles,
				basicRoles,
				elm$core$List$length(initialNames) - elm$core$List$length(basicRoles)));
		return _Utils_Tuple2(
	...
	function (maybeRoute, model) {
		if (maybeRoute.$ === 'Nothing') {
			...
			if (maybeRoute.a.$ === 'Home') {
				...
				var omikujiResultModel = _n3.a;
				var omikujiResultCmd = _n3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: author$project$Main$OmikujiResultPage(omikujiResultModel)
						}),
					omikujiResultCmd);
			}
		}
...
var author$project$Route$OmikujiResult = F2(
	function (a, b) {
		return {$: 'OmikujiResult', a: a, b: b};
	});
	...
	_List_fromArray(
		[
			...
			A2(
				...
				elm$url$Url$Parser$Query$string('names'))),
			A2(
			elm$url$Url$Parser$map,
			author$project$Route$OmikujiResult,
			A2(
				elm$url$Url$Parser$questionMark,
				A2(
					elm$url$Url$Parser$questionMark,
...
var author$project$Route$fromUrl = function (url) {
	...
	var _n0 = _Utils_Tuple2(
		elm$core$List$head(tempList),
		elm$core$List$tail(tempList));
	var effectivePath = _n0.a;
	var effectiveQuery = _n0.b;
	return A2(
...
var author$project$Main$OmikujiResultMsg = function (a) {
	return {$: 'OmikujiResultMsg', a: a};
};
var author$project$Page$Home$GoToResult = function (a) {
	return {$: 'GoToResult', a: a};
};
var author$project$Page$Home$alterRecordChecked = F3(
	function (bool, index, targetLists) {
		return A2(
			elm$core$List$indexedMap,
			F2(
				function (i, r) {
					return _Utils_eq(i, index) ? A2(author$project$Page$Home$Record, bool, r.name) : r;
				}),
			targetLists);
	});
var author$project$Page$Home$alterRecordName = F3(
	function (str, index, targetLists) {
		return A2(
			elm$core$List$indexedMap,
			F2(
				function (i, r) {
					return _Utils_eq(i, index) ? A2(author$project$Page$Home$Record, r.checked, str) : r;
				}),
			targetLists);
	});
...
var author$project$Page$Home$getEffectiveNames = function (model) {
	return A2(
		elm$core$String$join,
		',',
		A2(
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							records: A2(
								elm$core$List$cons,
								A2(author$project$Page$Home$Record, true, ''),
								model.records)
						}),
					elm$core$Platform$Cmd$none);
			case 'ChangeName':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							records: A3(author$project$Page$Home$alterRecordName, str, index, model.records)
						}),
					elm$core$Platform$Cmd$none);
			case 'ChangeChecked':
				var index = msg.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							records: A3(author$project$Page$Home$alterRecordChecked, bool, index, model.records)
						}),
					elm$core$Platform$Cmd$none);
			case 'ClickResult':
				return _Utils_Tuple2(
						...
						A2(
							...
							_List_fromArray(
								[
									...
									'names',
									author$project$Page$Home$getEffectiveNames(model)),
									A2(
...
var author$project$Page$OmikujiResult$copy = _Platform_outgoingPort('copy', elm$json$Json$Encode$string);
var elm$core$Tuple$pair = F2(
	function (a, b) {
		return _Utils_Tuple2(a, b);
	});
var author$project$Page$OmikujiResult$update = F2(
	function (msg, model) {
		var targetStr = A2(
			elm$core$String$join,
			'',
			A2(
				...
				A3(elm$core$List$map2, elm$core$Tuple$pair, model.names, model.roles)));
		return _Utils_Tuple2(
			model,
			author$project$Page$OmikujiResult$copy(targetStr));
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'HomeMsg':
				...
				if (_n3.$ === 'HomePage') {
					var homeModel = _n3.a;
					var _n4 = A2(author$project$Page$Home$update, homeMsg, homeModel);
					var newHomeModel = _n4.a;
					var homeCmd = _n4.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$HomePage(newHomeModel)
							}),
						A2(elm$core$Platform$Cmd$map, author$project$Main$HomeMsg, homeCmd));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			...
			default:
				var omikujiResultMsg = msg.a;
				var _n5 = model.page;
				if (_n5.$ === 'OmikujiResultPage') {
					var omikujiResultModel = _n5.a;
					var _n6 = A2(author$project$Page$OmikujiResult$update, omikujiResultMsg, omikujiResultModel);
					var newOmikujiResultModel = _n6.a;
					var omikujiResultCmd = _n6.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$OmikujiResultPage(newOmikujiResultModel)
							}),
						A2(elm$core$Platform$Cmd$map, author$project$Main$OmikujiResultMsg, omikujiResultCmd));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
		}
	});
var author$project$Page$Home$ClickResult = {$: 'ClickResult'};
var author$project$Page$Home$PlusClicked = {$: 'PlusClicked'};
...
var author$project$Component$Checkbox$view = F4(
	function (checkedMsg, nameMsg, isChecked, name) {
		return A2(
			elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Events$onCheck(checkedMsg)
						]),
					_List_Nil),
					A2(
					elm$html$Html$input,
...
var author$project$Page$Home$ChangeChecked = F2(
	function (a, b) {
		return {$: 'ChangeChecked', a: a, b: b};
	});
var author$project$Page$Home$ChangeName = F2(
	function (a, b) {
		return {$: 'ChangeName', a: a, b: b};
	});
var author$project$Page$Home$showList = function (records) {
	return A2(
		elm$core$List$indexedMap,
		F2(
			function (i, r) {
				return A4(
					author$project$Component$Checkbox$view,
					author$project$Page$Home$ChangeChecked(i),
					author$project$Page$Home$ChangeName(i),
					r.checked,
					r.name);
			}),
		records);
...
var author$project$Page$OmikujiResult$Copy = {$: 'Copy'};
var elm$html$Html$td = _VirtualDom_node('td');
var elm$html$Html$th = _VirtualDom_node('th');
var elm$html$Html$tr = _VirtualDom_node('tr');
var author$project$Page$OmikujiResult$showTableData = F2(
	function (nameList, roleList) {
		return A2(
			elm$core$List$cons,
			A2(
				elm$html$Html$tr,
			...
			A2(
				...
				A3(elm$core$List$map2, elm$core$Tuple$pair, nameList, roleList)));
	});
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('button is-info'),
								elm$html$Html$Events$onClick(author$project$Page$OmikujiResult$Copy)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('fas fa-clipboard')
											]),
										_List_Nil)
									]))
							]))
		...
		body: _List_fromArray(
			[
				...
				switch (_n0.$) {
					...
					case 'HomePage':
						var homePageModel = _n0.a;
						return A2(
							elm$html$Html$map,
							author$project$Main$HomeMsg,
							author$project$Page$Home$view(homePageModel));
					default:
						var omikujiResultPageModel = _n0.a;
						return A2(
							elm$html$Html$map,
							author$project$Main$OmikujiResultMsg,
							author$project$Page$OmikujiResult$view(omikujiResultPageModel));
				}
			}()
			]),
		title: 'omikuji'
